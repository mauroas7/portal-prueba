...
@section('title', 'Mi Perfil - Paciente')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            ...
                            <a href="{{ route('paciente.turnos') }}" class="block w-full text-left px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                Ver Mis Turnos
                            </a>
                            <a href="{{ route('paciente.estudios') }}" class="block w-full text-left px-4 py-2 bg-purple-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                Ver Mis Estudios
                            </a>
                        </div>
                    </div>
